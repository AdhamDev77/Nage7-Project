...
import { Chapter, Coupon, Course } from "@prisma/client";
...
export const columns: ColumnDef<Coupon>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const isPublished = row.getValue("isUsed") || false;
      return (
        <Badge className={cn("bg-sky-600", !isPublished && "bg-emerald-600")}>
          {isPublished ? "مستخدم" : "متاح"}
        </Badge>
      );
    },
  },
